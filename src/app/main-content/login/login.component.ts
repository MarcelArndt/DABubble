...
@Component({
  selector: 'app-login',
  standalone: true,
  imports: [LoginAnimationComponent, CommonModule, LoginAnimationInsideComponent, RouterModule, MainContentComponent, HeadmenuLoginComponent, SubmenuLoginComponent, SignUpComponent, SignInComponent, ChooseAvatarComponent, SuccessCreatingAccountComponent],
